...
class PreteensWhoSaidThatGame extends StatefulWidget {
  final int? index;
  final int? valid;
  ...
  @override
  PreteensWhoSaidThatGameState createState() => PreteensWhoSaidThatGameState();
}

class PreteensWhoSaidThatGameState extends GameState<PreteensWhoSaidThatGame> {
  PreteensWhoSaidThatGameState() : super('preteens', 'whosaidthat');
  ...
  @override
  Widget nextGame() {
    return PreteensWhoSaidThatGame(
      index: index! + 1,
