...
class PreschoolNameThePictureGame extends StatefulWidget {
  final int? index;
  final int? valid;
  ...
  @override
  PreschoolNameThePictureGameState createState() =>
      PreschoolNameThePictureGameState();
}

class PreschoolNameThePictureGameState
    extends GameState<PreschoolNameThePictureGame> {
  PreschoolNameThePictureGameState() : super('preschool', 'namethepicture');
  ...
  @override
  Widget nextGame() {
    return PreschoolNameThePictureGame(
      index: index! + 1,
  ...
  void initState() {
    ...
    background = 'bg-3.jpg';
    file = File(
        "${DatabaseService().downloadPath}/namethepicture/${question!['image']}");
  }
